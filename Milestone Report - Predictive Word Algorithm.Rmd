...
Since stop words are key words in the language excluding them would't provide a very usefull prediction algorithm. While stemming the data is useful to create n-grams it provides to be a challenge in using stem words to predict a next word. Lastly, sparse words were kept to provide a bigger dictionary.
...
top.plot <- training %>%
        ...
        labs(title = "Top Words by N_gram", x = "Words", fill = "N_gram")
